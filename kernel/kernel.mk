...
KOBJS := assert.o main.o raise.o start.o installHandler.o timeSetup.o userSetup.o  irqSetup.o S_Handler.o IRQ_Handler.o swi_exit.o swi_read.o swi_write.o swi_time.o swi_sleep.o  C_SWI_HANDLER.o C_IRQ_HANDLER.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
